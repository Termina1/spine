...
(function() {
  ...
  Spine.Route = (function(_super) {
    ...
    Route.bind('released', function(inst) {
      var i, route, stroute, _i, _len, _ref1, _results;
      if (!inst.setRoutes) {
        return;
      }
      _ref1 = this.routes;
      ...
      for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
        ...
        _results.push((function() {
          ...
          _ref2 = inst.setRoutes;
          _results1 = [];
          for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
            stroute = _ref2[_j];
            if (route && route.route.exec(stroute)) {
              _results1.push(this.routes.splice(i, 1));
            } else {
  ...
  Spine.Controller.include({
    route: function(path, callback) {
      if (this.setRoutes == null) {
        this.setRoutes = [];
      }
      this.setRoutes.push(path);
